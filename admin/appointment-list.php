	...
	try {
		...
		foreach ($sheetData as $row) {
		   ...
		   if ($i != 0 && $row[0] !='') {
				...
				$message .= '<a style="color:#fff;height:50px; margin-left:250px;margin-top:50px;font-size:18px; font-weight:bold; background-color:#17D4F4;border-radius:20px;padding:20px!important;padding-bottom:15px!important;display:block;text-align:center; text-underline:none!important;" href="http://vacapp.hridhamtech.com/appointment-scheduler.php">
