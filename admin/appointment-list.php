	...
	try {
		...
		foreach ($sheetData as $row) {
		   ...
		   if ($i != 0 && $row[0] !='') {
				...
				$message .= '<a style="color:#fff;font-size:18px; font-weight:bold; background-color:#17D4F4;border-radius:20px;padding:15px;text-align:center; text-underline:none;" href="http://vacapp.hridhamtech.com/appointment-scheduler.php">
