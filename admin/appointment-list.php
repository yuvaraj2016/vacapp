	...
	try {
		...
		foreach ($sheetData as $row) {
		   ...
		   if ($i != 0 && $row[0] !='') {
				...
				$message .= '<a style="color:#fff;height:50px!important; margin-left:200px;margin-top:50px;font-size:18px; font-weight:bold; background-color:#17D4F4;padding:10px!important;padding-bottom:13px!important;text-align:center; text-decoration:none!important;" href="http://vacapp.hridhamtech.com/appointment-scheduler.php">
